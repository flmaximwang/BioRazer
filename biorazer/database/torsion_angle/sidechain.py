...
SIDECHAIN_IC_DIHEDRAL = {
    ...
    'ARG': {
        ...
        ('CD', 'CG', 'NE', 'CZ'): -180.00,
        ('NE', 'CD', 'CZ', 'NH1'): 180.00,
        ('NE', 'NH1', 'CZ', 'NH2'): -180.00,
    },
    'ASN': {
        ('N', 'C', 'CA', 'CB'): -123.29,
        ('CA', 'N', 'CB', 'CG'): -180.00,
        ('CB', 'CA', 'CG', 'OD1'): 180.00,
        ('CB', 'OD1', 'CG', 'ND2'): -180.00,
    },
    'ASP': {
        ('N', 'C', 'CA', 'CB'): -122.56,
        ('CA', 'N', 'CB', 'CG'): 180.00,
        ('CB', 'CA', 'CG', 'OD1'): -180.00,
        ('CB', 'OD1', 'CG', 'OD2'): 180.00,
    },
    'CYS': {
        ('N', 'C', 'CA', 'CB'): -122.36,
        ('CA', 'N', 'CB', 'SG'): -180.00,
    ...
    'HIS': {
        ...
        ('CB', 'CA', 'CG', 'ND1'): 180.00,
        ('CG', 'CB', 'ND1', 'CE1'): 0.00,
        ('ND1', 'CG', 'CE1', 'NE2'): 179.96,
        ('CE1', 'ND1', 'NE2', 'CD2'): -179.97,
    },
    'ILE': {
        ('N', 'C', 'CA', 'CB'): -122.90,
        ('CA', 'N', 'CB', 'CG1'): 180.00,
        ('CB', 'CA', 'CG1', 'CD1'): 180.00,
        ('CA', 'CG1', 'CB', 'CG2'): -122.59,
    },
    'LEU': {
        ('N', 'C', 'CA', 'CB'): -122.18,
        ('CA', 'N', 'CB', 'CG'): 180.00,
        ('CB', 'CA', 'CG', 'CD1'): 180.00,
        ('CB', 'CD1', 'CG', 'CD2'): 121.06,
    },
    'LYS': {
        ('N', 'C', 'CA', 'CB'): -122.82,
        ('CA', 'N', 'CB', 'CG'): -180.00,
    ...
    'PHE': {
        ...
        ('CB', 'CA', 'CG', 'CD1'): 180.00,
        ('CG', 'CB', 'CD1', 'CE1'): -0.01,
        ('CD1', 'CG', 'CE1', 'CZ'): -179.98,
        ('CE1', 'CD1', 'CZ', 'CE2'): 179.98,
        ('CZ', 'CE1', 'CE2', 'CD2'): 179.97,
    },
    'PRO': {
        ('N', 'C', 'CA', 'CB'): -114.41,
        ('CA', 'N', 'CB', 'CG'): 149.29,
    ...
    'TRP': {
        ...
        ('CB', 'CA', 'CG', 'CD1'): 180.00,
        ('CG', 'CB', 'CD1', 'NE1'): -0.04,
        ('CD1', 'CG', 'NE1', 'CE2'): -179.89,
        ('NE1', 'CD1', 'CE2', 'CZ2'): 0.13,
        ('CE2', 'NE1', 'CZ2', 'CH2'): -0.04,
        ('CZ2', 'CE2', 'CH2', 'CZ3'): 179.89,
        ('CH2', 'CZ2', 'CZ3', 'CE3'): -179.94,
        ('CZ3', 'CH2', 'CE3', 'CD2'): 179.98,
    },
    'TYR': {
        ('N', 'C', 'CA', 'CB'): -122.90,
        ('CA', 'N', 'CB', 'CG'): -180.00,
        ('CB', 'CA', 'CG', 'CD1'): -180.00,
        ('CG', 'CB', 'CD1', 'CE1'): -0.00,
        ('CB', 'CD1', 'CG', 'CD2'): 180.00,
        ('CG', 'CB', 'CD2', 'CE2'): -0.00,
        ('CD2', 'CG', 'CE2', 'CZ'): -180.00,
        ('CE2', 'CD2', 'CZ', 'OH'): 0.00,
    },
    'VAL': {
        ('N', 'C', 'CA', 'CB'): -122.04,
        ('CA', 'N', 'CB', 'CG1'): -180.00,
        ('CA', 'CG1', 'CB', 'CG2'): 122.03,
    },
}
